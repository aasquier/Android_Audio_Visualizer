...
final class Constants {
    ...
    static final int SWITCH_VIS_TIME_ONE   = 1000;                      //Amount of time to switch from the first visualizer to the second.
    static final int SWITCH_VIS_TIME_TWO   = SWITCH_VIS_TIME_ONE + 1000; //Amount of time to switch from the first visualizer to the second.
