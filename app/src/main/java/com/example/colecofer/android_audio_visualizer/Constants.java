...
//    static final long REFRESH_DECIBEL_TIME = 16L;
    ...
    /** Vis1 constants */
    static final int LINE_AMT              = 30;                  //Number of lines to display on the screen
    ...
    /** Vis3 constants */
    static final int SCREEN_VERTICAL_HEIGHT_V3 = 40;
    ...
    static final int SCREEN_VERTICAL_HEIGHT = 40;
...
//    static final float AMPLIFIER            = 0.0000075f;
    static final float AMPLIFIER            = 0.000025f;
