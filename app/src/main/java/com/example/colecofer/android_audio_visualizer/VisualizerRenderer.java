...
//    private int colorHandle;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        {
            GLES20.glShaderSource(vertexShaderHandle, vertexShader);//VisualizerModel.getInstance().currentVisualizer.getVertexShader());
        ...
        {
            GLES20.glShaderSource(fragmentShaderHandle, fragmentShader); //isualizerModel.getInstance().currentVisualizer.getFragmentShader());
